...
import {
    ...
    IconPlug,
    IconCircleMinus,
    IconUsersGroup, IconLink, IconUser, IconLanguage, IconRadar
...
export default function Navbar() {
    ...
    // Define navigation links inside component to ensure t() is reactive
    const navbarLinks = [
        ...
        { link: '/sensor', label: t('Sensor'), icon: IconRadar },
